...
pub contract NFTStorefront {
    ...
    pub var ListingForSales:{UInt64: ListingView}
    ...
    pub struct ListingView {
       ...
       init(nftID: UInt64,salePrice: UFix64,name: String,url: String,sellerAddress: Address){
           self.nftID = nftID
    ...
    pub resource interface StorefrontManager {
        ...
        pub fun createListing(
            nftProviderCapability: Capability<&{ExampleNFT.ExampleNFTCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>,
            nftID: UInt64,
            saleCuts: [SaleCut],
    ...
    pub resource Storefront : StorefrontManager, StorefrontPublic {
        ...
        //
         pub fun createListing(
            ...
            destroy oldListing
            let exampleNftRef = nftProviderCapability.borrow()!.borrowExampleNFT(id:nftID)!
            NFTStorefront.ListingForSales[listingResourceID] = ListingView(nftID:nftID,salePrice:listingPrice,name:exampleNftRef.name,url:exampleNftRef.url,sellerAddress:sellerAddress)
        ...
        pub fun cleanup(listingResourceID: UInt64) {
            ...
            destroy listing
            NFTStorefront.ListingForSales.remove(key:listingResourceID)
        }
